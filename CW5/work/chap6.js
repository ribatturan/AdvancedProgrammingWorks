...
class Temperature extends Menu {
...
class InchCm extends Menu{
	constructor(cm = 0){
		super();
		this.cm = cm;
	}
	get inch(){
		return (this.cm *1/2.54) 
	}
	set inch(value = 0){
		return (this.cm = value * 2.54) 
	}
	toString(){
		return this.cm +" cm."
	}
...
class Inch extends Menu {
  constructor() {
    super();
    this.InchCm = new InchCm(5);
	
}
setCm(value){
	this.InchCm.cm = value;
	
}
setInch(value){
		this.InchCm.inch = value;
