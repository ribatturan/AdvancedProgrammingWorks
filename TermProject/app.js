...
const getFirstOpenCellForColumn = (colIndex) => {
    ...
    const columnWithoutTop = column.slice(0,6); //column arrayine en üstteki yer dahil oldugu için ayırdık.
...
const handleCellMouseOver = (e) => {
    ...
    const cell = e.target;  
    const [rowIndex,colIndex] = getCellLocation(cell); //sol tarafta destrcuturing yapılmaktadır.
    const topCell = topCells[colIndex];
